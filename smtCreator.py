...
# Parameters
d = 2  # dimension
ell = 1  # number of additional MUBs
    ...
    for m2 in range(1, ell+1):
        ...
        for j in range(d):
            for k in range(d):
                ...
                smt_lines.append(f"(assert (= (+ {' '.join(all_terms)}) {d}.0))")
...
# Save to file
smt_file_path = "/mnt/c/B_Informatica/jaar3/scriptie/MUBwSMT/smt2/mub2_ell1.smt2"
