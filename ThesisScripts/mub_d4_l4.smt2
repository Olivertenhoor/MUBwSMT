...
; Variable bounds
(assert (or (= f10_0 0.0) (= f10_0 0.25) (= f10_0 0.5) (= f10_0 0.75) (= f10_0 1.0) (= f10_0 1.25) (= f10_0 1.5) (= f10_0 1.75)))
(assert (or (= f10_1 0.0) (= f10_1 0.25) (= f10_1 0.5) (= f10_1 0.75) (= f10_1 1.0) (= f10_1 1.25) (= f10_1 1.5) (= f10_1 1.75)))
(assert (or (= f10_2 0.0) (= f10_2 0.25) (= f10_2 0.5) (= f10_2 0.75) (= f10_2 1.0) (= f10_2 1.25) (= f10_2 1.5) (= f10_2 1.75)))
(assert (or (= f10_3 0.0) (= f10_3 0.25) (= f10_3 0.5) (= f10_3 0.75) (= f10_3 1.0) (= f10_3 1.25) (= f10_3 1.5) (= f10_3 1.75)))
(assert (or (= f11_0 0.0) (= f11_0 0.25) (= f11_0 0.5) (= f11_0 0.75) (= f11_0 1.0) (= f11_0 1.25) (= f11_0 1.5) (= f11_0 1.75)))
(assert (or (= f11_1 0.0) (= f11_1 0.25) (= f11_1 0.5) (= f11_1 0.75) (= f11_1 1.0) (= f11_1 1.25) (= f11_1 1.5) (= f11_1 1.75)))
(assert (or (= f11_2 0.0) (= f11_2 0.25) (= f11_2 0.5) (= f11_2 0.75) (= f11_2 1.0) (= f11_2 1.25) (= f11_2 1.5) (= f11_2 1.75)))
(assert (or (= f11_3 0.0) (= f11_3 0.25) (= f11_3 0.5) (= f11_3 0.75) (= f11_3 1.0) (= f11_3 1.25) (= f11_3 1.5) (= f11_3 1.75)))
(assert (or (= f12_0 0.0) (= f12_0 0.25) (= f12_0 0.5) (= f12_0 0.75) (= f12_0 1.0) (= f12_0 1.25) (= f12_0 1.5) (= f12_0 1.75)))
(assert (or (= f12_1 0.0) (= f12_1 0.25) (= f12_1 0.5) (= f12_1 0.75) (= f12_1 1.0) (= f12_1 1.25) (= f12_1 1.5) (= f12_1 1.75)))
(assert (or (= f12_2 0.0) (= f12_2 0.25) (= f12_2 0.5) (= f12_2 0.75) (= f12_2 1.0) (= f12_2 1.25) (= f12_2 1.5) (= f12_2 1.75)))
(assert (or (= f12_3 0.0) (= f12_3 0.25) (= f12_3 0.5) (= f12_3 0.75) (= f12_3 1.0) (= f12_3 1.25) (= f12_3 1.5) (= f12_3 1.75)))
(assert (or (= f13_0 0.0) (= f13_0 0.25) (= f13_0 0.5) (= f13_0 0.75) (= f13_0 1.0) (= f13_0 1.25) (= f13_0 1.5) (= f13_0 1.75)))
(assert (or (= f13_1 0.0) (= f13_1 0.25) (= f13_1 0.5) (= f13_1 0.75) (= f13_1 1.0) (= f13_1 1.25) (= f13_1 1.5) (= f13_1 1.75)))
(assert (or (= f13_2 0.0) (= f13_2 0.25) (= f13_2 0.5) (= f13_2 0.75) (= f13_2 1.0) (= f13_2 1.25) (= f13_2 1.5) (= f13_2 1.75)))
(assert (or (= f13_3 0.0) (= f13_3 0.25) (= f13_3 0.5) (= f13_3 0.75) (= f13_3 1.0) (= f13_3 1.25) (= f13_3 1.5) (= f13_3 1.75)))
(assert (or (= f20_0 0.0) (= f20_0 0.25) (= f20_0 0.5) (= f20_0 0.75) (= f20_0 1.0) (= f20_0 1.25) (= f20_0 1.5) (= f20_0 1.75)))
(assert (or (= f20_1 0.0) (= f20_1 0.25) (= f20_1 0.5) (= f20_1 0.75) (= f20_1 1.0) (= f20_1 1.25) (= f20_1 1.5) (= f20_1 1.75)))
(assert (or (= f20_2 0.0) (= f20_2 0.25) (= f20_2 0.5) (= f20_2 0.75) (= f20_2 1.0) (= f20_2 1.25) (= f20_2 1.5) (= f20_2 1.75)))
(assert (or (= f20_3 0.0) (= f20_3 0.25) (= f20_3 0.5) (= f20_3 0.75) (= f20_3 1.0) (= f20_3 1.25) (= f20_3 1.5) (= f20_3 1.75)))
(assert (or (= f21_0 0.0) (= f21_0 0.25) (= f21_0 0.5) (= f21_0 0.75) (= f21_0 1.0) (= f21_0 1.25) (= f21_0 1.5) (= f21_0 1.75)))
(assert (or (= f21_1 0.0) (= f21_1 0.25) (= f21_1 0.5) (= f21_1 0.75) (= f21_1 1.0) (= f21_1 1.25) (= f21_1 1.5) (= f21_1 1.75)))
(assert (or (= f21_2 0.0) (= f21_2 0.25) (= f21_2 0.5) (= f21_2 0.75) (= f21_2 1.0) (= f21_2 1.25) (= f21_2 1.5) (= f21_2 1.75)))
(assert (or (= f21_3 0.0) (= f21_3 0.25) (= f21_3 0.5) (= f21_3 0.75) (= f21_3 1.0) (= f21_3 1.25) (= f21_3 1.5) (= f21_3 1.75)))
(assert (or (= f22_0 0.0) (= f22_0 0.25) (= f22_0 0.5) (= f22_0 0.75) (= f22_0 1.0) (= f22_0 1.25) (= f22_0 1.5) (= f22_0 1.75)))
(assert (or (= f22_1 0.0) (= f22_1 0.25) (= f22_1 0.5) (= f22_1 0.75) (= f22_1 1.0) (= f22_1 1.25) (= f22_1 1.5) (= f22_1 1.75)))
(assert (or (= f22_2 0.0) (= f22_2 0.25) (= f22_2 0.5) (= f22_2 0.75) (= f22_2 1.0) (= f22_2 1.25) (= f22_2 1.5) (= f22_2 1.75)))
(assert (or (= f22_3 0.0) (= f22_3 0.25) (= f22_3 0.5) (= f22_3 0.75) (= f22_3 1.0) (= f22_3 1.25) (= f22_3 1.5) (= f22_3 1.75)))
(assert (or (= f23_0 0.0) (= f23_0 0.25) (= f23_0 0.5) (= f23_0 0.75) (= f23_0 1.0) (= f23_0 1.25) (= f23_0 1.5) (= f23_0 1.75)))
(assert (or (= f23_1 0.0) (= f23_1 0.25) (= f23_1 0.5) (= f23_1 0.75) (= f23_1 1.0) (= f23_1 1.25) (= f23_1 1.5) (= f23_1 1.75)))
(assert (or (= f23_2 0.0) (= f23_2 0.25) (= f23_2 0.5) (= f23_2 0.75) (= f23_2 1.0) (= f23_2 1.25) (= f23_2 1.5) (= f23_2 1.75)))
(assert (or (= f23_3 0.0) (= f23_3 0.25) (= f23_3 0.5) (= f23_3 0.75) (= f23_3 1.0) (= f23_3 1.25) (= f23_3 1.5) (= f23_3 1.75)))
(assert (or (= f30_0 0.0) (= f30_0 0.25) (= f30_0 0.5) (= f30_0 0.75) (= f30_0 1.0) (= f30_0 1.25) (= f30_0 1.5) (= f30_0 1.75)))
(assert (or (= f30_1 0.0) (= f30_1 0.25) (= f30_1 0.5) (= f30_1 0.75) (= f30_1 1.0) (= f30_1 1.25) (= f30_1 1.5) (= f30_1 1.75)))
(assert (or (= f30_2 0.0) (= f30_2 0.25) (= f30_2 0.5) (= f30_2 0.75) (= f30_2 1.0) (= f30_2 1.25) (= f30_2 1.5) (= f30_2 1.75)))
(assert (or (= f30_3 0.0) (= f30_3 0.25) (= f30_3 0.5) (= f30_3 0.75) (= f30_3 1.0) (= f30_3 1.25) (= f30_3 1.5) (= f30_3 1.75)))
(assert (or (= f31_0 0.0) (= f31_0 0.25) (= f31_0 0.5) (= f31_0 0.75) (= f31_0 1.0) (= f31_0 1.25) (= f31_0 1.5) (= f31_0 1.75)))
(assert (or (= f31_1 0.0) (= f31_1 0.25) (= f31_1 0.5) (= f31_1 0.75) (= f31_1 1.0) (= f31_1 1.25) (= f31_1 1.5) (= f31_1 1.75)))
(assert (or (= f31_2 0.0) (= f31_2 0.25) (= f31_2 0.5) (= f31_2 0.75) (= f31_2 1.0) (= f31_2 1.25) (= f31_2 1.5) (= f31_2 1.75)))
(assert (or (= f31_3 0.0) (= f31_3 0.25) (= f31_3 0.5) (= f31_3 0.75) (= f31_3 1.0) (= f31_3 1.25) (= f31_3 1.5) (= f31_3 1.75)))
(assert (or (= f32_0 0.0) (= f32_0 0.25) (= f32_0 0.5) (= f32_0 0.75) (= f32_0 1.0) (= f32_0 1.25) (= f32_0 1.5) (= f32_0 1.75)))
(assert (or (= f32_1 0.0) (= f32_1 0.25) (= f32_1 0.5) (= f32_1 0.75) (= f32_1 1.0) (= f32_1 1.25) (= f32_1 1.5) (= f32_1 1.75)))
(assert (or (= f32_2 0.0) (= f32_2 0.25) (= f32_2 0.5) (= f32_2 0.75) (= f32_2 1.0) (= f32_2 1.25) (= f32_2 1.5) (= f32_2 1.75)))
(assert (or (= f32_3 0.0) (= f32_3 0.25) (= f32_3 0.5) (= f32_3 0.75) (= f32_3 1.0) (= f32_3 1.25) (= f32_3 1.5) (= f32_3 1.75)))
(assert (or (= f33_0 0.0) (= f33_0 0.25) (= f33_0 0.5) (= f33_0 0.75) (= f33_0 1.0) (= f33_0 1.25) (= f33_0 1.5) (= f33_0 1.75)))
(assert (or (= f33_1 0.0) (= f33_1 0.25) (= f33_1 0.5) (= f33_1 0.75) (= f33_1 1.0) (= f33_1 1.25) (= f33_1 1.5) (= f33_1 1.75)))
(assert (or (= f33_2 0.0) (= f33_2 0.25) (= f33_2 0.5) (= f33_2 0.75) (= f33_2 1.0) (= f33_2 1.25) (= f33_2 1.5) (= f33_2 1.75)))
(assert (or (= f33_3 0.0) (= f33_3 0.25) (= f33_3 0.5) (= f33_3 0.75) (= f33_3 1.0) (= f33_3 1.25) (= f33_3 1.5) (= f33_3 1.75)))
(assert (or (= f40_0 0.0) (= f40_0 0.25) (= f40_0 0.5) (= f40_0 0.75) (= f40_0 1.0) (= f40_0 1.25) (= f40_0 1.5) (= f40_0 1.75)))
(assert (or (= f40_1 0.0) (= f40_1 0.25) (= f40_1 0.5) (= f40_1 0.75) (= f40_1 1.0) (= f40_1 1.25) (= f40_1 1.5) (= f40_1 1.75)))
(assert (or (= f40_2 0.0) (= f40_2 0.25) (= f40_2 0.5) (= f40_2 0.75) (= f40_2 1.0) (= f40_2 1.25) (= f40_2 1.5) (= f40_2 1.75)))
(assert (or (= f40_3 0.0) (= f40_3 0.25) (= f40_3 0.5) (= f40_3 0.75) (= f40_3 1.0) (= f40_3 1.25) (= f40_3 1.5) (= f40_3 1.75)))
(assert (or (= f41_0 0.0) (= f41_0 0.25) (= f41_0 0.5) (= f41_0 0.75) (= f41_0 1.0) (= f41_0 1.25) (= f41_0 1.5) (= f41_0 1.75)))
(assert (or (= f41_1 0.0) (= f41_1 0.25) (= f41_1 0.5) (= f41_1 0.75) (= f41_1 1.0) (= f41_1 1.25) (= f41_1 1.5) (= f41_1 1.75)))
(assert (or (= f41_2 0.0) (= f41_2 0.25) (= f41_2 0.5) (= f41_2 0.75) (= f41_2 1.0) (= f41_2 1.25) (= f41_2 1.5) (= f41_2 1.75)))
(assert (or (= f41_3 0.0) (= f41_3 0.25) (= f41_3 0.5) (= f41_3 0.75) (= f41_3 1.0) (= f41_3 1.25) (= f41_3 1.5) (= f41_3 1.75)))
(assert (or (= f42_0 0.0) (= f42_0 0.25) (= f42_0 0.5) (= f42_0 0.75) (= f42_0 1.0) (= f42_0 1.25) (= f42_0 1.5) (= f42_0 1.75)))
(assert (or (= f42_1 0.0) (= f42_1 0.25) (= f42_1 0.5) (= f42_1 0.75) (= f42_1 1.0) (= f42_1 1.25) (= f42_1 1.5) (= f42_1 1.75)))
(assert (or (= f42_2 0.0) (= f42_2 0.25) (= f42_2 0.5) (= f42_2 0.75) (= f42_2 1.0) (= f42_2 1.25) (= f42_2 1.5) (= f42_2 1.75)))
(assert (or (= f42_3 0.0) (= f42_3 0.25) (= f42_3 0.5) (= f42_3 0.75) (= f42_3 1.0) (= f42_3 1.25) (= f42_3 1.5) (= f42_3 1.75)))
(assert (or (= f43_0 0.0) (= f43_0 0.25) (= f43_0 0.5) (= f43_0 0.75) (= f43_0 1.0) (= f43_0 1.25) (= f43_0 1.5) (= f43_0 1.75)))
(assert (or (= f43_1 0.0) (= f43_1 0.25) (= f43_1 0.5) (= f43_1 0.75) (= f43_1 1.0) (= f43_1 1.25) (= f43_1 1.5) (= f43_1 1.75)))
(assert (or (= f43_2 0.0) (= f43_2 0.25) (= f43_2 0.5) (= f43_2 0.75) (= f43_2 1.0) (= f43_2 1.25) (= f43_2 1.5) (= f43_2 1.75)))
(assert (or (= f43_3 0.0) (= f43_3 0.25) (= f43_3 0.5) (= f43_3 0.75) (= f43_3 1.0) (= f43_3 1.25) (= f43_3 1.5) (= f43_3 1.75)))
