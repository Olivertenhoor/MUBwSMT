...
(assert (and (> nul0 -0.001) (< nul0 0.001) ))
(assert (and (> nul1 -0.001) (< nul1 0.001) ))
...
(assert (and (> twee0 1.999) (< twee0 2.001) ))
(assert (and (> twee1 1.999) (< twee1 2.001) ))
...
(assert (= nul0 (+ (cos (* pi (- f20_0 f21_0))) (cos (* pi (- f20_1 f21_1))))))
(assert (= nul1 (+ (sin (* pi (- f20_0 f21_0))) (sin (* pi (- f20_1 f21_1))))))
