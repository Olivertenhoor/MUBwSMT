...
(assert (or (= f30_2 0.0) (= f30_2 0.5) (= f30_2 1.0) (= f30_2 1.5)))
(assert (or (= f30_3 0.0) (= f30_3 0.5) (= f30_3 1.0) (= f30_3 1.5)))
(assert (or (= f31_0 0.0) (= f31_0 0.5) (= f31_0 1.0) (= f31_0 1.5)))
(assert (or (= f31_1 0.0) (= f31_1 0.5) (= f31_1 1.0) (= f31_1 1.5)))
(assert (or (= f31_2 0.0) (= f31_2 0.5) (= f31_2 1.0) (= f31_2 1.5)))
(assert (or (= f31_3 0.0) (= f31_3 0.5) (= f31_3 1.0) (= f31_3 1.5)))
(assert (or (= f32_0 0.0) (= f32_0 0.5) (= f32_0 1.0) (= f32_0 1.5)))
(assert (or (= f32_1 0.0) (= f32_1 0.5) (= f32_1 1.0) (= f32_1 1.5)))
(assert (or (= f32_2 0.0) (= f32_2 0.5) (= f32_2 1.0) (= f32_2 1.5)))
(assert (or (= f32_3 0.0) (= f32_3 0.5) (= f32_3 1.0) (= f32_3 1.5)))
(assert (or (= f33_0 0.0) (= f33_0 0.5) (= f33_0 1.0) (= f33_0 1.5)))
(assert (or (= f33_1 0.0) (= f33_1 0.5) (= f33_1 1.0) (= f33_1 1.5)))
(assert (or (= f33_2 0.0) (= f33_2 0.5) (= f33_2 1.0) (= f33_2 1.5)))
(assert (or (= f33_3 0.0) (= f33_3 0.5) (= f33_3 1.0) (= f33_3 1.5)))
